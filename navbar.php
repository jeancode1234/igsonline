...
<body>
  ...
  <div class="w-full text-gray-700 bg-gray-900 py-2 dark-mode:text-gray-200 dark-mode:bg-gray-800 ">
        ...
        <?php if (isset($_SESSION['auth_user'])) {
          if ($_SESSION['auth_role'] == "1") { ?>
            ...
            <div @click.away="open = false" class="relative" x-data="{ open: false }">
              ...
              <?php $cat = $connect->query("SELECT * FROM categorie ORDER BY cat_id DESC"); ?>
              <div x-show="open" class="fixed z-10 right-0 w-full mt-2 origin-top-right rounded-md shadow-lg md:w-48">
                <div class="px-2 py-2 bg-gray-800 dark-mode:bg-gray-800">
                  <?php
                  if ($cat->rowCount() > 0) {
                    while ($result = $cat->fetch()) { ?>
                      <a class="block px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#"><?php echo $result['nom']; ?></a>
                  <?php
                    }
                  }
                  ?>
            ...
            <div @click.away="open = false" class="relative" x-data="{ open: false }">
              ...
              <?php $serv = $connect->query("SELECT * FROM services ORDER BY service_id DESC"); ?>
              <div x-show="open" class="fixed z-10 right-0 w-full mt-2 origin-top-right rounded-md shadow-lg md:w-48">
                <div class="px-2 py-2 bg-gray-800 dark-mode:bg-gray-800">
                  <?php
                  if ($serv->rowCount() > 0) {
            ...
            <a class="px-4  py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg text-white dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-orange-400 focus:text-orange-400  focus:outline-none focus:shadow-outline" href="#">Contact</a>
            <div @click.away="open = false" class="relative" x-data="{ open: false }">
              <button @click="open = !open" class="flex bg-white text-gray-800 flex-row items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-left rounded-sm  dark-mode:bg-transparent dark-mode:hover:text-white dark-mode:focus:bg-gray-600 dark-mode:hover:bg-gray-600 md:w-auto md:inline md:mt-0 md:ml-4 hover:text-orange-400 focus:text-orange-400  focus:outline-none focus:shadow-outline">
