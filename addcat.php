...
<div class = "content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
    ...
    <div class="w-full border sm:max-w-sm md:max-w-2xl lg:max-w-4xl mx-auto">
                <h3 class="pt-4 text-2xl text-center font-bold text-gray-800">Formulaire d'ajout d'une categorie</h3>
                <form action="cat_code.php" method="POST" enctype="multipart/form-data" class="w-full space-y-8 p-8">
                        ...
                        <div class="relative w-full md:w-1/2">
                            <textarea type="text"  require name="description" id="floating_outlined" class="block h-52 px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-gray-800 peer" placeholder=" "></textarea>
