    ...
    <div class="content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
        ...
        <nav class="flex px-5 py-3 text-gray-700 justify-between rounded-lg bg-gray-50 dark:bg-[#1E293B] " aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li class="inline-flex items-center">
                    <a href="addserv.php" class=" px-4 py-2 rounded bg-gray-800 hover:bg-gray-900 inline-flex items-center text-sm font-medium text-white hover:text-white dark:text-white dark:hover:text-white">
            ...
            <div class="w-96 md:w-80">
                <form action="adminser.php" method="get" class="w-full flex relative rounded-full border-1 overflow-hidden   border border-gray-800/10">
        ...
        <div class="overflow-x-scroll">
            <table class="w-full whitespace-nowrap">
                ...
                <?php
                $list = $connect->query("SELECT * FROM services ORDER BY service_id desc");
                if (isset($_GET['submit']) && !empty($_GET['search'])) {
                    $all = htmlspecialchars($_GET['search']);
                    $list = $connect->query("SELECT * FROM services WHERE nom LIKE '%". $all."%' ORDER BY service_id desc");
                }
                if ($list->rowCount() > 0) {
                        ...
                        <tr class="border-b border-gray-700">
                            ...
                            <td class="py-3 px-2">
                                <div class="inline-flex items-center space-x-3">
                                    ...
                                    <form action="serv_code.php" method="post">
                                        <button type="submit" name="delete_serv" value="<?php echo $a['service_id']; ?>" class="mt-2">
                    ...
                    <h1 class="text-2xl text-red-600 font-serif font-medium text-center">Aucun service trouvé</h1>
                <?php
                }; ?>
